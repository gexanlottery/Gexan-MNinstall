...
bind='$EXTERNALIP'
masternodeaddr='$EXTERNALIP':19666
masternodeprivkey='$key'
masternode=1
' | sudo -E tee ~/.Gexan/Gexan.conf >/dev/null 2>&1
chmod 0600 ~/.Gexan/Gexan.conf

#Starting coin
(
  crontab -l 2>/dev/null
  echo '@reboot sleep 30 && gexd -daemon -shrinkdebugfile'
) | crontab
(
  crontab -l 2>/dev/null
